...
\Q:("$select v, u, sum(q)as sum_q, sum(x)as sum_x, sum(x*(1-xd))as rev, sum(x*(1-xd)*(1+xt))as tax, avg(q)as avg_q, avg(xd)as avg_xd, count(*)as count_o
 ...
 order by s.x desc rowcount 100"
 "$select l.o, o.d, o.i, sum(l.x*(1-l.xd))as rev from c, o, l
 ...
 "$select j, count(*)as count_o from o
 ...
 "$select sum(x*xd)as sum_x from l where ds>=date'1994-01-01' and ds<date'1994-01-01'+1 years and xd between .05 and .07 and q<24"
 ...
 from o,l where o.o=l.o and l.h in('MAIL','SHIP') and l.dc<l.dr and l.ds<l.dc 
  and l.dr>=date'1994-01-01' and l.dr<date'1994-01-01'+1 years group by l.h order by l.h"
